...
pub fn build(b: *std.Build) void {
    ...
    sdl3webgpu_mod.addIncludePath(sdl3_headers);
    sdl3webgpu_mod.addObjectFile(sdl3_library);
    sdl3webgpu_mod.addIncludePath(webgpu_headers);
    sdl3webgpu_mod.addObjectFile(webgpu_library);
